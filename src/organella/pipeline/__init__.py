...
Row layout, as :mod:`organella.model.rows` describes it:
...
from organella.pipeline.batch import analyse, group_of
from organella.pipeline.objects import ObjectResult, measure_object
from organella.pipeline.parts import discard_parts, settings_fingerprint
from organella.pipeline.pool import (
